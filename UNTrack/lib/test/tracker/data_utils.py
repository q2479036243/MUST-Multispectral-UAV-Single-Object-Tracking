...
class Preprocessor(object):
    def __init__(self):
        ...
        self.mean_hsi_8 = torch.tensor([0.45, 0.328, 0.326, 0.322, 0.328, 0.324, 0.326, 0.327]).view((1, 8, 1, 1)).cuda()
        self.std_hsi_8 = torch.tensor([0.194, 0.163, 0.16, 0.156, 0.164, 0.139, 0.148, 0.146]).view((1, 8, 1, 1)).cuda()
    ...
    def process(self, img_arr: np.ndarray, amask_arr: np.ndarray):
        ...
        elif img_tensor.shape[1] == 8:
            img_tensor_norm = ((img_tensor / 255.0) - self.mean_hsi_8) / self.std_hsi_8  # (1,8,H,W)
